...
// }
//
// func (u *UserHandler) CreateUserRequest(c *gin.Context) {
// 	var req CreateUserRequest
// 	if err := c.ShouldBindJSON(&req); err != nil {
// 		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
// 		return
...
// 		// TenantID:  tenantID,
// 	}
// 	if err := u.svc.CreateUser(c.Request.Context(), user); err != nil {
// 		c.JSON(http.StatusConflict, gin.H{"error": err.Error()})
// 		return
// 	}
// 	c.JSON(http.StatusCreated, gin.H{
...
// 	}
//
// 	users, err := h.svc.List(c.Request.Context(), tenantID, offset, limit)
// 	if err != nil {
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
// 		return
// 	}
...
// 	}
// 	req.ID = userID
// 	err := h.svc.Update(c.Request.Context(), tenantID.(string), &req)
// 	if err != nil {
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error})
// 		return
// 	}
